...
<body>
    <div class="container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft">
                     <b><font color="#FFFFFF" style="font-size:30px"> <p > Shopping is Fun !! </p></font></b>
        ...
        <div class="grid_10">
            <div class="box round first">
               <button type ="submit" name ="submit2" onclick="window.location.href='adminLogin.php'" > <h2>
               Admin </h2>  
                 </button> &nbsp &nbsp &nbsp &nbsp
                 <button type ="submit" name ="submit2" onclick="window.location.href='/Market Shop/user/cart.php'" > <h2>
                 Client </h2>  
